...
class TestBooksCollector:
    ...
    def test_add_new_book_invalid_book_name(self, collector, book_name):
    ...
    def test_set_book_genre_true(self, collector):
        ...
        assert collector.books_genre.get('Гордость и предубеждение и зомби') == "Комедии"
    ...
    def test_get_books_for_children_true(self, collector):
        ...
        assert collector.get_books_for_children() == ['Репка']

    def test_get_books_for_children_age_rating_not_for_children(self, collector):
    ...
    def test_add_book_in_favorites_true(self, collector):
        ...
        assert 'Дюймовочка' in collector.favorites
    ...
    def test_get_list_of_favorites_books_true(self, collector):
        collector.add_new_book('Дюймовочка')
        collector.add_book_in_favorites('Дюймовочка')
        assert collector.get_list_of_favorites_books() == ['Дюймовочка']
